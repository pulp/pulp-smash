...
class ErratumContentRWRTest(utils.BaseAPITestCase):
    ...
    def setUpClass(cls):
        ...
        packages = cls.parsed['updates']['update']['pkglist'][0]['packages']
        packages = sorted(packages, key=lambda x: x['filename'])
        cls.parsed['updates']['update']['pkglist'][0]['packages'] = packages

        packages = cls.adv1['pkglist'][0]['packages']
        packages = sorted(packages, key=lambda x: x['filename'])
        cls.adv1['pkglist'][0]['packages'] = packages
