...
class UpdateInfoTestCase(utils.BaseAPITestCase):
    ...
    def test_reboot_not_suggested(self):
        ...
        This test may be skipped if `Pulp #1782`_ or `Pulp #2052`_ is open.

        .. _Pulp #1782: https://pulp.plan.io/issues/1782
        .. _Pulp #2052: https://pulp.plan.io/issues/2052
        """
        ...
        if (self.cfg.version >= Version('2.9') and
                selectors.bug_is_untestable(2052, self.cfg.version)):
            self.skipTest('https://pulp.plan.io/issues/2052')
