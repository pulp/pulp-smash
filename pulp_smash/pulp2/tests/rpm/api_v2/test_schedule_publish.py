...
:mod:`pulp_smash.pulp2.tests.rpm.api_v2.test_sync_publish` hold true.
...
from pulp_smash.pulp2.tests.rpm.api_v2.utils import (
    gen_repo,
    gen_distributor,
)
from pulp_smash.pulp2.tests.rpm.utils import set_up_module as setUpModule  # noqa pylint:disable=unused-import
