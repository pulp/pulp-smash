...
:mod:`pulp_smash.pulp2.tests.platform.api_v2.test_repository` and
`pulp_smash.pulp2.tests.ostree.api_v2.test_crud` hold true. The following
trees of assumptions are explored in this module::
...
from pulp_smash.pulp2.tests.ostree.utils import gen_repo
from pulp_smash.pulp2.tests.ostree.utils import set_up_module as setUpModule  # noqa pylint:disable=unused-import
